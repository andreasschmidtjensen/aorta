...
public class Prolog implements /*Castagna 06/2011*/IProlog,/**/ Serializable {
	...
	public Prolog() {
		...
		try {
			if ("IKVM.NET".equals(System.getProperty("java.vm.name"))) // XXX: HOTFIX for AJPF since System.getProperty("java.vm.name") is apparently null and vm.sysprop.keys = java.vm.name does not work
