...
public class A_PSLLexer extends Lexer {
	...
	public final void mCONST() throws RecognitionException {
		try {
			int _type = CONST;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// A_PSL.g:147:7: ( 'a' .. 'z' ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )* )
			// A_PSL.g:147:9: 'a' .. 'z' ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )*
			{
			matchRange('a','z'); 
			// A_PSL.g:147:18: ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )*
			loop3:
			while (true) {
				int alt3=2;
	...
	public final void mNUMBER() throws RecognitionException {
		try {
			int _type = NUMBER;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// A_PSL.g:149:8: ( '0' .. '9' ( '0' .. '9' )* )
			// A_PSL.g:149:10: '0' .. '9' ( '0' .. '9' )*
			{
			matchRange('0','9'); 
			// A_PSL.g:149:19: ( '0' .. '9' )*
			loop4:
	...
	public final void mCOMMENT() throws RecognitionException {
		try {
			int _type = COMMENT;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// A_PSL.g:160:2: ( '/*' ( options {greedy=false; } : . )* '*/' )
			// A_PSL.g:160:4: '/*' ( options {greedy=false; } : . )* '*/'
			{
			match("/*"); 

			// A_PSL.g:160:9: ( options {greedy=false; } : . )*
			loop7:
			while (true) {
				int alt7=2;
	...
	public void mTokens() throws RecognitionException {
		// A_PSL.g:1:8: ( ALWAYS | FINALLY | UNTIL | RELEASE | AND | OR | NOT | IMP | BELIEVE | GOAL | ORG | OPT | FALSE | INTENTION | ACTION | PERCEPT | TRUE | CONST | UNNAMED_VAR | NUMBER | OPENBRACKET | CLOSEBRACKET | SQOPENBRACKET | SQCLOSEBRACKET | COMMASEP | NEWLINE | WS | COMMENT )
		int alt8=28;
