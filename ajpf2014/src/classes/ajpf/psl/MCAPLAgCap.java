 ...
 * 
 */
public class MCAPLAgCap extends Proposition {
//	 protected static Logger log = JPF.getLogger("ajpf.psl.MCAPLOrgBelief");
	 ...
	 */
	public MCAPLAgCap(MCAPLAgent a, MCAPLFormula f) {
		fmla = f;
		agent = a;
	 ...
	 */
	public MCAPLAgCap(String s, MCAPLcontroller c, MCAPLFormula f) {
		this(c.getAgent(s), f);
	}
	...
	//	System.err.println("Checking " + fmla);
		boolean result = agent.hasCapability(fmla);
	...
	public boolean equals(Object p) {
		if (p instanceof MCAPLAgCap) {
			return (((MCAPLAgCap) p).getCapability().equals(fmla) && ((MCAPLAgCap) p).getAgent().equals(agent));
		}
	 ...
	 */
	public MCAPLFormula getCapability() {
		return fmla;
	}
	 ...
	 */
	public MCAPLAgCap clone() {
		return(new MCAPLAgCap(agent, (MCAPLFormula) fmla.clone()));
	}
	...
	public String toString() {
		String s = "C(" + agent.getAgName() + "," + fmla.toString() + ")";
		return s;
	}
