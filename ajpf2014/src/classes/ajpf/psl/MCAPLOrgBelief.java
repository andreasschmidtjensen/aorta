 ...
 * 
 */
public class MCAPLOrgBelief extends Proposition {
//	 protected static Logger log = JPF.getLogger("ajpf.psl.MCAPLOrgBelief");
	 ...
	 */
	public MCAPLOrgBelief(MCAPLAgent a, MCAPLFormula f) {
		fmla = f;
		agent = a;
	 ...
	 */
	public MCAPLOrgBelief(String s, MCAPLcontroller c, MCAPLFormula f) {
		this(c.getAgent(s), f);
	}
	...
	//	System.err.println("Checking " + fmla);
		boolean result = agent.hasOrganizationalBelief(fmla);
	...
	public boolean equals(Object p) {
		if (p instanceof MCAPLOrgBelief) {
			return (((MCAPLOrgBelief) p).getOrgBel().equals(fmla) && ((MCAPLOrgBelief) p).getAgent().equals(agent));
		}
	 ...
	 */
	public MCAPLOrgBelief clone() {
		return(new MCAPLOrgBelief(agent, (MCAPLFormula) fmla.clone()));
	}
	...
	public String toString() {
		String s = "Org(" + agent.getAgName() + "," + fmla.toString() + ")";
		return s;
	}
