...
public class GenerateApplicableRulesIfNonEmpty extends GenerateApplicablePlansIfNonEmpty 
{
	public void apply(AILAgent a) {
		Iterator<ApplicablePlan> generated = a.filterPlans(a.appPlans(a.getIntention()));
		((OOPLAgent)a).addGenerated(generated);
		a.setApplicablePlans(generated);
	}
}
