...
/**
 * A Gwendolen Reasonning Cycle. An Example of how to set up a language specific
 * reasoning cycle. Likely to change as the implementation of OSRule's changes
 * in AIL.
 *
