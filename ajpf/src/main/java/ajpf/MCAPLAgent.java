...
//	private boolean sleeping  = false;
	 ...
	 */
	 public void reason() {
		 AJPFLogger.fine("ajpf.MCAPLAgent", "Entering reason");
			 AJPFLogger.fine("ajpf.MCAPLAgent", "wants to sleep: " + agent.MCAPLwantstosleep());
		...
		//	if (!notified) {
			...
			// System.err.println("a");
				...
				// shut everything down.
					...
					//if (outputlevel > 1) {
						AJPFLogger.fine("ajpf.MCAPLAgent", "Sleeping agent " + name);					
	...
	public boolean hasOrganizationalBelief(MCAPLFormula fmla) {
		return agent.MCAPLhasOrganizationalBelief(fmla);
	}

	public boolean hasOrganizationalOption(MCAPLFormula fmla) {
