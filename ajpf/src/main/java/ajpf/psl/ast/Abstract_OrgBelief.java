 ...
 * 
 */
public class Abstract_OrgBelief extends Abstract_Proposition {
	 ...
	 */
	public Abstract_OrgBelief(String agName, Abstract_Formula f) {
		fmla =  f;
		agent = agName;
	}
	...
	public MCAPLProperty toMCAPL(MCAPLmas mas, MCAPLcontroller c) {
		return new MCAPLOrgBelief(c.getAgent(agent), (MCAPLFormula) fmla.toMCAPL());
	}
	...
	public int newJPFObject(MJIEnv env) {
		int ref = env.newObject("ajpf.psl.ast.Abstract_OrgBelief");
